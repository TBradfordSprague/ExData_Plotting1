...
plot(pwrTbl$DateTime, pwrTbl$Global_active_power, type="n", 
     xlab="", ylab="Global Active Power (kilowatts)")
lines(pwrTbl$DateTime, pwrTbl$Global_active_power)

plot(pwrTbl$DateTime, pwrTbl$Voltage, type="n", 
     xlab="datetime", ylab="Voltage")
lines(pwrTbl$DateTime, pwrTbl$Voltage)
...
plot(pwrTbl$DateTime, pwrTbl$Global_reactive_power, type="n", 
     xlab="datetime")
lines(pwrTbl$DateTime, pwrTbl$Global_reactive_power)
dev.off()
